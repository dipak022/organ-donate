            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-55">
                        <h3><span>Organ Donation Form</span></h3>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-contact contact_form"  novalidate="novalidate" action="{{ route('organ.doantion.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="" class="col-form-label">Specific organs tissues name</label>
                                        <input class="form-control" name="specific_organs_tissues_name" id="specific_organs_tissues_name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Specific organs tissues name'" placeholder="Enter Specific organs tissues name" >
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
